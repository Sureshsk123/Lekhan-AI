  ...
  const handleEvaluate = async () => {
    ...
    try {
      ...
      const res = await evaluateHandwriting({
        imageBase64: dataUrl,
        expectedText: targetChar
      });
      if (res && res.data) {
        setEvalResult({
          score: res.data.score || 50,
          formation: res.data.score || 50,
          spacing: 85,
          consistency: 89,
          feedback: res.data.feedback || 'Evaluated!'
        });
      } else {
        setEvalResult({
          score: 88,
      ...
      <div className="flex-1 flex max-w-7xl mx-auto w-full">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 overflow-hidden pb-24 lg:pb-12">
          ...
          <div>
            ...
            <p className="text-xs text-content-tertiary mt-1">Practice writing Indic characters on the canvas for instant stroke feedback</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <GlassCard className="p-6 flex flex-col items-center space-y-4">
              ...
              {/* Canvas Box */}
              <div className="relative border-4 border-emerald-500/30 rounded-3xl overflow-hidden shadow-inner bg-surface-primary">
                <canvas
                  ref={canvasRef}
              ...
              <div className="flex items-center justify-between w-full pt-2">
                ...
                <button
                  onClick={clearCanvas}
                  className="px-3.5 py-2 rounded-xl bg-surface-tertiary text-xs font-bold text-rose-500 flex items-center gap-1 hover:bg-rose-50 transition-colors"
                >
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3.5 rounded-2xl bg-accent-primary text-white font-bold shadow-lg shadow-sm hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
              >
            ...
            <GlassCard className="p-6 space-y-4">
              ...
              {evalResult ? (
                <div className="space-y-4 text-center">
                  <div className="inline-flex flex-col items-center justify-center w-24 h-24 rounded-full bg-accent-primary text-white shadow-xl">
